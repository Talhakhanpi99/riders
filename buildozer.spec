...
android.permissions = RECORD_AUDIO,POST_NOTIFICATIONS,INTERNET,ACCESS_FINE_LOCATION,ACCESS_COARSE_LOCATION,FOREGROUND_SERVICE,FOREGROUND_SERVICE_MICROPHONE,FOREGROUND_SERVICE_LOCATION,FOREGROUND_SERVICE_CAMERA,FOREGROUND_SERVICE_CONNECTED_DEVICE,CAMERA,CALL_PHONE,SEND_SMS,READ_SMS,VIBRATE,MODIFY_AUDIO_SETTINGS,BLUETOOTH,BLUETOOTH_CONNECT,CHANGE_WIFI_STATE,ACCESS_WIFI_STATE
android.api = 34
