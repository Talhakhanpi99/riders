...
android.permissions = RECORD_AUDIO,POST_NOTIFICATIONS,INTERNET,ACCESS_FINE_LOCATION,ACCESS_COARSE_LOCATION,FOREGROUND_SERVICE,FOREGROUND_SERVICE_MICROPHONE,FOREGROUND_SERVICE_LOCATION,FOREGROUND_SERVICE_CAMERA,FOREGROUND_SERVICE_CONNECTED_DEVICE,CAMERA,READ_CONTACTS,CALL_PHONE,SEND_SMS,READ_SMS,VIBRATE,MODIFY_AUDIO_SETTINGS,WRITE_SETTINGS,BLUETOOTH,BLUETOOTH_CONNECT,CHANGE_WIFI_STATE,ACCESS_WIFI_STATE
android.api = 34
...
services = Listener:offline_listener_service.py:foreground:sticky
[buildozer]
log_level = 2
warn_on_root = 1
